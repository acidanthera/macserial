...
static const char *AppleModelCode[][APPLE_MODEL_CODE_MAX] = {
  ...
  /* MacBookPro11,1*/ {"FH00", "FGYY", "FH01", "FH02", "FH03", "FH04", "FH05", "FRF6", "FRF7", "FRQF", "FT4Q", "FT4R", "FT4T", "FT4V", "FTC9", "FTCD", "FTCH", "FTCK", "FTCL", "FTPH", "FTPJ", "FTPK", "FTT4", "FVVW", "FVWQ", "G4N6", "G4N7"},
  /* MacBookPro11,2*/ {"G86R"},
  /* MacBookPro11,3*/ {"FR1M"},
  /* MacBookPro11,4*/ {"G8WN", "G8WL"},
  /* MacBookPro11,5*/ {"G85Y", "G8WP"},
  ...
  /* MacPro4,1     */ {"K9Y"},
  /* MacPro5,1     */ {"EUH", "HFC", "HFA", "HFD", "HFF", "HFG", "HFJ", "HFK", "HFL", "HFN", "EUF", "F4MG"},
